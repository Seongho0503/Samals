...
module.exports = {
  ...
  networks: {
    ...
    //   provider: function () {
    //     return new HDWalletProvider(MNEMONIC, "https://20.196.209.2:8545");
    //   }
    // },
    ssafy: {
    ...
    rinkeby: {
      provider: function () {
          return new HDWalletProvider(MNEMONIC, "https://rinkeby.infura.io/v3/dcf676ddcf9a40a68b9ec811d8fb355d");
      },
      network_id: 4,
    },
  },
