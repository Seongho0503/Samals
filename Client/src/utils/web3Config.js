...
export const aceTokenContract = new web3.eth.Contract(aceTokenAbi, aceTokenContractAddress);

export const animalNftContract = new web3.eth.Contract(animalNftAbi, animalNftContractAddress);

export const mascortNftContract = new web3.eth.Contract(mascortNftAbi, mascortNftContractAddress);
...
export const createNftSaleContract = (nftSaleAddress) => {
  const nftSaleContract = new web3.eth.Contract(nftSaleAbi, nftSaleAddress);
