          ...
          <div id="slides">
            ...
            >
              ...
              <div className="body">
                ...
                <div className="headline">Photo by Benjamin Hung</div>
                <a
                  href="https://unsplash.com/photos/EYmhcdGuYmI"
                  target="_blank"
                >
                  <div className="link">View on Unsplash</div>
                </a>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="body">
                <div className="location">Mong Kok, Hong Kong</div>
                <div className="headline">Photo by Ryan Tang</div>
                <a
            ...
            >
              ...
              <div className="body">
                <div className="location">Incheon, South Korea</div>
                <div className="headline">Photo by Steve Roe</div>
                <a
            ...
            >
              ...
              <div className="body">
                <div className="location">Wan Chai, Hong Kong</div>
                <div className="headline">Photo by Sean Foley</div>
                <a
            ...
            >
              ...
              <div className="body">
                <div className="location">Shibuya-ku, Japan</div>
                <div className="headline">Photo by Alex Knight</div>
                <a
            ...
            >
              ...
              <div className="body">
                ...
                <div className="headline">Photo by Jesus In Taiwan</div>
                <a
